...
prompt = {}
prompt["instruction"] = (
    'Here is the historical interactions of a user: {inters}. And his personalized preferences are as follows: "{explicit_preference}". Your task is to recommend an item that is consistent with the user\'s preference.'
)
prompt["response"] = "{item}"
...
prompt = {}
prompt["instruction"] = (
    'The user has interacted with a list of items, which are as follows: {inters}. Based on these interacted items, the user current intent is as follows "{user_related_intention}", and your task is to generate an item that matches the user\'s current intent.'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'As a recommender system, you are assisting a user who has recently interacted with the following items: {inters}. The user expresses a desire to obtain another item with the following characteristics: "{item_related_intention}". Please recommend an item that meets these criteria.'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'Using the user\'s current query: "{query}" and his historical interactions: {inters}, you can estimate the user\'s preferences "{explicit_preference}". Please respond to the user\'s query by selecting an item that best matches his preference and query.'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'The user needs a new item and searches for: "{query}". In addition, he has previously interacted with: {inters}. You can obtain his preference by analyzing his historical interactions: "{explicit_preference}". Can you recommend an item that best matches the search query and preferences?'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'Based on the user\'s historical interactions with the following items: {inters}. You can infer his preference by observing the historical interactions: "{explicit_preference}". Now the user wants a new item and searches for: "{query}". Please select a suitable item that matches his preference and search intent.'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'Suppose you are a search engine, now a user searches that: "{query}", can you select an item to respond to the user\'s query?'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "As a search engine, your task is to answer the user's query by generating a related item. The user's query is provided as \"{query}\". Please provide your generated item as your answer."
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'As a recommender system, your task is to recommend an item that is related to the user\'s request, which is specified as follows: "{query}". Please provide your recommendation.'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'You meet a user\'s query: "{query}". Please respond to this user by selecting an appropriate item.'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    'Your task is to recommend the best item that matches the user\'s query. Here is the search query of the user: "{query}", tell me the item you recommend.'
)
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "The user has interacted with items {inters} in chronological order. Please estimate his preferences."
)
...
prompt = {}
prompt["instruction"] = (
    "Based on the items that the user has interacted with: {inters}, can you infer what preferences he has?"
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "Can you provide a summary of the user's preferences based on his historical interactions: {inters}?"
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "After interacting with items {inters} in order, what preferences do you think the user has?"
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "Here is the item interaction history of the user: {inters}, could you please infer the user's preferences."
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "Based on the user's historical interaction records: {inters}, what are your speculations about his preferences?"
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "Given the user's historical interactive items arranged in chronological order: {inters}, what can be inferred about the preferences of the user?"
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "Can you speculate on the user's preferences based on his historical item interaction records: {inters}?"
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "What is the preferences of a user who has previously interacted with items {inters} sequentially?"
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "Using the user's historical interactions as input data, summarize the user's preferences. The historical interactions are provided as follows: {inters}."
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
...
prompt = {}
prompt["instruction"] = (
    "Utilizing the ordered list of the user's historical interaction items as a reference, please make an informed estimation of the user's preferences. The historical interactions are as follows: {inters}."
)
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
